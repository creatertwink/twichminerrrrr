...
twitch_miner = TwitchChannelPointsMiner(
    ...
    priority=[                                  # Custom priority in this case for example:
        Priority.DROPS                    # - We want first of all to catch all watch streak from all streamers                                   # - When we don't have anymore watch streak to catch, wait until all drops are collected over the streamers
    ...
    logger_settings=LoggerSettings(
        ...
        telegram=Telegram(                                                          # You can omit or set to None if you don't want to receive updates on Telegram
            chat_id=1073176285,                                                      # Chat ID to send messages @getmyid_bot
            token="7300450864:AAGeJDxXNcoWj-nlhgR_lScJab5PsAu-zwM",                          # Telegram API token @BotFather
